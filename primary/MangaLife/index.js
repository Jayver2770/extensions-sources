(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.Sources = f() } })(function () {
    var define, module, exports; return (function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
        1: [function (require, module, exports) {
            ...
            const MangaLifeSettings_1 = require("./MangaLifeSettings");
            const MangaLifeParser_1 = require("./MangaLifeParser");
            const MANGALIFE_DOMAIN = 'https://www.manga4life.com';
            const MANGALIFE_MOBILE_DOMAIN = 'https://www.manga4life.com';
            ...
            exports.MangaLifeInfo = {
                version: '2.1.4',
                name: 'MangaLife',
                description: 'Extension that pulls comics from MangaLife.',
                author: 'btylerh7',
            ...
            class MangaLife extends paperback_extensions_common_1.Source {
                constructor() {
                    super(...arguments);
                    this.parser = new MangaLifeParser_1.Parser();
                ...
                async getSourceMenu() {
                    return Promise.resolve(createSection({
                        ...
                        rows: async () => [
                            await (0, MangaLifeSettings_1.contentSettings)(this.stateManager),
                        ]
                    }));
                }
                getMangaShareUrl(mangaId) {
                    return `${MANGALIFE_DOMAIN}/${langString}/${mangaId}`; // langString is 'en' by default.
                }
                async getMangaDetails(mangaId) {
                    const lang = await (0, MangaLifeSettings_1.getLanguages)(this.stateManager);
                    langString = lang[0] ?? 'en'; // This variable is only to be used in the "getMangaShareUrl" function.
                    const request = createRequestObject({
                        url: `${MANGALIFE_MOBILE_DOMAIN}/${lang[0]}/${mangaId}`,
                        method: 'GET'
                    });
                ...
                async getChapterDetails(mangaId, chapterId) {
                    ...
                    const request = createRequestObject({
                        url: `${MANGALIFE_DOMAIN}/${lang[0]}/${newId}&episode_no=${chapterId}`,
                        method: 'GET',
                    });
                    const response = await this.requestManager.schedule(request, 3);
                    const $ = this.cheerio.load(response.data);
                ...
                async getSearchResults(query, metadata) {
                    ...
                    if (query.title) {
                        ...
                        request = createRequestObject({
                            url: `${MANGALIFE_DOMAIN}/${lang[0]}/search?keyword=${(query.title ?? '').replace(/ /g, '+')}&searchType=${searchType}&page=${page}`,
                            method: 'GET'
                        });
                    }
                    else {
                        ...
                        request = createRequestObject({
                            url: `${MANGALIFE_DOMAIN}/${lang[0]}/genre`,
                            method: 'GET'
                        });
                    }
                ...
                async getHomePageSections(sectionCallback) {
                    const lang = await (0, MangaLifeSettings_1.getLanguages)(this.stateManager);
                    const request = createRequestObject({
                        url: `${MANGALIFE_DOMAIN}/${lang[0]}/top`,
                        method: 'GET'
                    });
        ...
        }, { "./MangaLifeParser": 57, "./MangaLifeSettings": 58, "paperback-extensions-common": 13 }], 57: [function (require, module, exports) {
            "use strict";
            Object.defineProperty(exports, "__esModule", { value: true });
                ...
                parseSearchResults($, langString, type, tagSearch) {
                    ...
                    if (type == 'tag') {
                        ...
                        */
                        ...
                        // Find corresponding list of mangas
                        ...
                        /*
                           ...
                           the index. For example, if the tag 'drama' is tagTitlesArray[1], then the drama mangas
                        ...
                        */
                        ...
                        // Use the index to add the correct mangas to the results
                    ...
                    form: createForm({
                        ...
                        sections: () => {
                            return Promise.resolve([
                                createSection({
                                    id: 'content',
                                    footer: 'Please choose the language that you would like to view MangaLife in.',
                                    rows: () => {
                                        return Promise.all([
